...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		$salt = 'random_salt_string'; // Generate a random salt for each user
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			if($userCount == 0)
			{
			      ...
			      $query = "insert into users (user_id,user_name,password,date) values ('$user_id','$user_name','$password' , '$current_time')";
...
<html>
<head>
	<title>SVCC Faculty Signup</title>
...
<h1>SVCC Faculty Signup</h1>
	...
	<div id="box">
		...
		<form method="post">
			...
			<a href="adminlogin.php">Click to Login</a><br><br>
